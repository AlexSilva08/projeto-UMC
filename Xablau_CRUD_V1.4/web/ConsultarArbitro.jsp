  ...
  <div class="container"> 
      ...
      <div class="box2">
          ...
          <form action="ControllerManterArbitro" method="post">
              Codigo do Arbitro: <input type="text" name="cadCodArbitro" class="form-control"><br>
              
              <input type="submit" name="btnOpArbitro" value="Consultar Codigo" class="btn btn-light">
              <input type="submit" name="btnOpArbitro" value="Consultar Todos" class="btn btn-light">
          </form>
          <br><br>
