  ...
  <div class="container"> 
      ...
      <div class="box2">
          ...
          <form action="ControllerManterCategoria" method="post">
              Descrição: <input type="text" name="cadDescCategoria" class="form-control" required><br>
              Idade: <input type="text" name="cadIdadeCategoria" class="form-control" required><br>
              Sexo: <input type="text" name="cadSexoCategoria" class="form-control" required><br>
              
              <input type="submit" name="btnOpCategoria" value="Cadastrar"  class="btn btn-light">
