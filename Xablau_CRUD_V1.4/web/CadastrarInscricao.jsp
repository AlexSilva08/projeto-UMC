<%-- 
    Document   : CadastrarInscricao
    Created on : Nov 28, 2021, 1:57:41 AM
    Author     : 11181502562
--%>
  ...
  <div class="container"> 
      ...
      <div class="box2">
          ...
          <form action="ControllerManterInscricao" method="post">
              Atleta: <input type="text" name="codAtleta" class="form-control"><br>
              Categoria: <input type="text" name="codCategoria" class="form-control"><br>
              Competição: <input type="text" name="codCompeticao" class="form-control"><br>
